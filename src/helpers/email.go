...
func SendEmailAuth(user models.User, endpoint string, header string) {
  ...
  if endpoint == "verify-email" {
    result, err = parseTemplate("/go/src/app/src/templates/verify-email.html", templateData)
    fmt.Println(err)
  } else {
    result, err = parseTemplate("/go/src/app/src/templates/reset-password.html", templateData)
    fmt.Println(err)
  }
...
func SendEmailBookingConfirmation(userBio models.UserBio, flight models.Flight, booking models.Booking, header string) {
  ...
  // parse html template
  result, _ := parseTemplate("/go/src/app/src/templates/booking.html", templateData)
...
func SendEmailPaymentConfirmation(userBio models.UserBio, payment models.Payment, header string) {
  ...
  // parse html template
  result, _ := parseTemplate("/go/src/app/src/templates/payment.html", templateData)
